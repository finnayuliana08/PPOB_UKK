...
--
-- Host: 127.0.0.1
-- Generation Time: 23 Okt 2019 pada 08.12
...
--
ALTER TABLE `tagihan`
  ADD CONSTRAINT `tagihan_ibfk_1` FOREIGN KEY (`id_pengguna`) REFERENCES `penggunaan` (`id_penggunaan`);
COMMIT;
